...
public class Pokemon
{
    ...
    public int Attack => Mathf.FloorToInt((_base.Attack * _level)/100.0f)+10;
    public int MaxHP => Mathf.FloorToInt((_base.MaxHP * _level)/100.0f)+2;
